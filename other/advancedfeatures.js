...
//unit testing is when you test a function to make sure it works as expected.  end to end testing is when you test the entire application to make sure it works as expected. integration testing is when you test a function to make sure it works with other functions as expected.
